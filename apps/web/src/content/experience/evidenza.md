...
- Built Spark-based ETL for recurring backfills and heavy joins across YouTube metadata and extracted creative signals; centralized 500 B2B ads in MySQL (Hive) and trained performance models (CTR, engagement, completion rate), driving a 34% engagement lift via recommendation outputs
